<fieldset>
    ...
    <input type="text" 
        id="titulo" name="propiedad[titulo]" 
    ...
    <input type="file" 
        id="imagen" name="propiedad[imagen]" 
        accept="image/jpeg, image/png">

    <?php if($propiedad->imagen) { ?>
        <img src="/bienesraices/images/<?php echo $propiedad->imagen; ?>" class="imagen-small">
    <?php } ?>
...
<fieldset>
    ...
    <input type="number" 
        id="habitaciones" name="propiedad[habitaciones]" 
    ...
    <input type="number" 
        id="estacionamiento" name="propiedad[estacionamiento]" 
        placeholder="Ej: 3" min="1" max="9" 
